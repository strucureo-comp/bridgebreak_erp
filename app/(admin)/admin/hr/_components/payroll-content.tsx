            ...
            <DialogContent className="max-w-md">
              ...
              <form onSubmit={handleCreateSalary} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-medium text-muted-foreground">Basic Salary (AED)</Label>
          ...
          <Dialog open={generateOpen} onOpenChange={setGenerateOpen}>
            ...
            <DialogContent className="max-w-sm">
              ...
              <form onSubmit={handleGenerate} className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-primary h-10 font-medium text-xs">Generate Batch</Button>
              </form>
            </DialogContent>
          </Dialog>
        </div>
