        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-6">
                {filteredRequests.map(r => (
                    <Card key={r.id} onClick={() => router.push(`/admin/operations/support/${r.id}`)} className="rounded-[2.5rem] border-none shadow-sm bg-card overflow-hidden group hover:shadow-xl transition-all duration-500 cursor-pointer">
