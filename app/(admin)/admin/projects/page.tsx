        ...
        <Tabs defaultValue="all" className="space-y-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
            <TabsList className="inline-flex p-1 bg-slate-100 rounded-2xl">
              ...
              <TabsTrigger value="operations" className="rounded-xl px-8 font-bold data-[state=active]:bg-white data-[state=active]:shadow-sm">Operations</TabsTrigger>
          ...
          <TabsContent value="operations" className="animate-in fade-in slide-in-from-bottom-2">
            <ProjectsContent />
          </TabsContent>
