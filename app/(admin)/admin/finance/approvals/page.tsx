                ...
                <div className="space-y-10 pb-12">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="space-y-1">
                            <h1 className="text-4xl font-black tracking-tight text-foreground">{getModuleLabel('approvals')}</h1>
                    ...
                    <div className="flex flex-col items-center justify-center py-32 bg-card rounded-[3rem] shadow-sm space-y-8 text-center border-4 border-slate-50">
                        <div className="relative">
                            ...
                            <div className="absolute -top-4 -right-4 h-12 w-12 rounded-full bg-primary flex items-center justify-center text-card-foreground shadow-lg animate-pulse">
                                <ShieldCheck size={24} />
                            </div>
                        </div>
                        <div className="max-w-md space-y-3 px-6">
                            <h3 className="text-3xl font-black text-foreground">Governance Console</h3>
