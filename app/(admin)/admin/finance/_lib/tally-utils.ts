...
import { TallyEngine, DEFAULT_ACCOUNTS, Account } from '@/app/(admin)/admin/finance/_lib/tally-engine';
import type { CurrencyCode } from '@/app/(admin)/admin/finance/_lib/finance-config';
