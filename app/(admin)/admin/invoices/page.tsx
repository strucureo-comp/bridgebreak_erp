      ...
      <div className="space-y-6 max-w-7xl mx-auto pb-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button onClick={() => router.push('/admin/invoices/new')} size="sm" className="h-10 gap-2 font-bold shadow-sm">
        ...
        <div className="bg-card border border-border rounded-lg shadow-sm divide-y divide-border">
          {filteredInvoices.map(inv => (
            <div key={inv.id} onClick={() => router.push(`/admin/invoices/${inv.id}`)} className="p-4 flex items-center justify-between hover:bg-muted/50 cursor-pointer transition-colors group">
